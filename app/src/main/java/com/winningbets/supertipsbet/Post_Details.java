   ...
   // private InterstitialAd interstitialAd;
       ...
       /* autoLinkTextView2.setAutoLinkOnClickListener(new AutoLinkOnClickListener() {
            ...
            public void onAutoLinkTextClick(AutoLinkMode autoLinkMode, String matchedText) {
                if (autoLinkMode == AutoLinkMode.MODE_CUSTOM)
                    try {
                        Intent RateIntent =
                                new Intent("android.intent.action.VIEW", Uri.parse("https://t.me/SportTipsters"));
                        startActivity(RateIntent);
                    }catch (Exception e){
                        Toast.makeText(getApplicationContext(),"Unable to connect try again later...",
                                Toast.LENGTH_SHORT).show();
        ...
        if (postKey != null) {
            ...
            mRef = FirebaseDatabase.getInstance().getReference().child("stb").child(selection).child(postKey);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            try {
                alert.setMessage(
                        "Winner Tips Developers built the SuperTipsbet Predictions app as a free app. This SERVICE is provided by WinnerTips Developers at no cost and is intended for use as is.\n" +
                                "\n" +
            ...
            String shareBody = "Start winning BIG with the best football tips app on play store . Download here https://play.google.com/store/apps/details?id=com.winningbets.supertipsbet";
